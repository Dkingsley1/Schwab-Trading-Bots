...
# -----------------------------
# Event calendar: regular spikes in volatility

def simulate_event_calendar(n=5000):
    prices = np.zeros(n)
    prices[0] = 100.0
    drift = 0.0001
    base_vol = 0.008
...
def train_brain():
    ...
    prices = simulate_event_calendar(n=5000)
    ...
    save_artifacts(brain, config, metrics, run_tag="brain_refinery_v18_event_calendar")
