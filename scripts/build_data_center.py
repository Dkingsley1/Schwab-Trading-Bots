...
def main() -> int:
    ...
    sources = [
        ...
        SourceDef("sleeve_slo_latest", PROJECT_ROOT / "governance" / "watchdog" / "sleeve_slo_latest.json", "watchdog", "file"),
        SourceDef("allocator_dir", PROJECT_ROOT / "governance" / "allocator", "watchdog", "dir"),
        SourceDef("allocator_latest", PROJECT_ROOT / "governance" / "allocator" / "sleeve_allocator_latest.json", "watchdog", "file"),
        SourceDef("risk_dir", PROJECT_ROOT / "governance" / "risk", "watchdog", "dir"),
        SourceDef("risk_latest", PROJECT_ROOT / "governance" / "risk" / "portfolio_risk_latest.json", "watchdog", "file"),
        SourceDef("execution_budget_latest", PROJECT_ROOT / "governance" / "risk" / "execution_budget_latest.json", "watchdog", "file"),
        SourceDef("state_snapshot_drills", PROJECT_ROOT / "exports" / "state_snapshot_drills", "watchdog", "dir"),
        ...
        SourceDef("executive_dashboard", PROJECT_ROOT / "exports" / "executive_dashboard", "sql", "dir"),
