...
def build_payload(
    ...
    *,
    ...
    payload = {
        ...
        "successful_attempt_count": sum(1 for row in attempts if _safe_int(row.get("rc"), 1) == 0),
        "failed_attempt_count": sum(1 for row in attempts if _safe_int(row.get("rc"), 1) != 0),
        ...
        "initial_graph": {
            ...
            "authority_violation_count": _safe_int(initial_graph.get("authority_violation_count"), 0),
            "blocked_nodes": [str(item) for item in _as_list(initial_graph.get("blocked_nodes"))],
            "degraded_nodes": [str(item) for item in _as_list(initial_graph.get("degraded_nodes"))],
            "stale_nodes": [str(item) for item in _as_list(initial_graph.get("stale_nodes"))],
        },
        "final_graph": {
            "overall_status": final_status,
            ...
            "authority_violation_count": _safe_int(final_graph.get("authority_violation_count"), 0),
            "blocked_nodes": [str(item) for item in _as_list(final_graph.get("blocked_nodes"))],
            "degraded_nodes": [str(item) for item in _as_list(final_graph.get("degraded_nodes"))],
            "stale_nodes": [str(item) for item in _as_list(final_graph.get("stale_nodes"))],
        },
