...
# The canonical supervisor owns the all-sleeves parent. Fresh child artifacts
# must not mask a missing parent after a drain or crash.
export SHADOW_WATCHDOG_ALLOW_SCHWAB_STANDBY_HEARTBEATS="${SHADOW_WATCHDOG_ALLOW_SCHWAB_STANDBY_HEARTBEATS:-0}"
