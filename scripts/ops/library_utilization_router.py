...
PACKAGE_LANE_OVERRIDES: dict[str, str] = {
    ...
    "river": "statistical_ml",
    "linearmodels": "statistical_ml",
    "formulaic": "statistical_ml",
    "interface-meta": "statistical_ml",
    "mypy-extensions": "statistical_ml",
    "pyhdfe": "statistical_ml",
    "cvxpy": "quant_derivatives_risk",
    "clarabel": "quant_derivatives_risk",
    "highspy": "quant_derivatives_risk",
    "osqp": "quant_derivatives_risk",
    "qdldl": "quant_derivatives_risk",
    "scs": "quant_derivatives_risk",
    "sparsediffpy": "quant_derivatives_risk",
