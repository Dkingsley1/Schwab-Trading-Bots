    ...
    *,
    ...
    sections = [
        ...
        _section(
            ...
            next_action=(
                ...
                else "optional: set BOT_SECOND_COLD_ROOT to a non-protected BOT_COLD, BOT_ARCHIVE, or BOT_RETENTION target"
            ),
    ...
    payload: dict[str, Any] = {
        ...
        "second_cold_target": {
            ...
            "protected_volume_refused": bool(second_cold_path is not None and _is_protected_volume(second_cold_path)),
            "approved_video_cold_archive_enabled": False,
            "approved_video_cold_archive_root": "",
        },
        "retention_report_card": {
