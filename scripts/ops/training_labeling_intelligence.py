...
CENTRAL_BANK_CONTEXT_SOURCE_ID = "central_bank_liquidity_context"
GLOBAL_CENTRAL_BANK_SOURCE_ID = "global_central_bank_context"
CENTRAL_BANK_SYNC_SOURCE_ID = "central_bank_cross_source_context"
...
FREE_LABEL_CONTEXT_SOURCE_MAP: dict[str, list[str]] = {
    ...
    "liquidity_state": ["market_micro_context", "extended_quant_context", "public_policy_context", CENTRAL_BANK_CONTEXT_SOURCE_ID, GLOBAL_CENTRAL_BANK_SOURCE_ID, CENTRAL_BANK_SYNC_SOURCE_ID],
    ...
    "funding_context": ["crypto_market_context", "fx_market_context", CENTRAL_BANK_CONTEXT_SOURCE_ID, GLOBAL_CENTRAL_BANK_SOURCE_ID, CENTRAL_BANK_SYNC_SOURCE_ID],
    ...
    "rates_context": ["fx_market_context", "official_macro_context", "public_policy_context", CENTRAL_BANK_CONTEXT_SOURCE_ID, GLOBAL_CENTRAL_BANK_SOURCE_ID, CENTRAL_BANK_SYNC_SOURCE_ID],
    "rate_context": ["fx_market_context", "official_macro_context", "public_policy_context", CENTRAL_BANK_CONTEXT_SOURCE_ID, GLOBAL_CENTRAL_BANK_SOURCE_ID, CENTRAL_BANK_SYNC_SOURCE_ID],
    "rates_curve": ["fx_market_context", "official_macro_context", "extended_quant_context", CENTRAL_BANK_CONTEXT_SOURCE_ID, GLOBAL_CENTRAL_BANK_SOURCE_ID, CENTRAL_BANK_SYNC_SOURCE_ID],
    "duration_context": ["official_macro_context", "extended_quant_context", CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "inflation_context": ["official_macro_context", "public_macro_feeds", "public_policy_context", CENTRAL_BANK_SYNC_SOURCE_ID],
    "macro_context": ["macro_crossstack", "official_macro_context", "public_macro_feeds", "public_policy_context", CENTRAL_BANK_CONTEXT_SOURCE_ID, GLOBAL_CENTRAL_BANK_SOURCE_ID, CENTRAL_BANK_SYNC_SOURCE_ID],
    "macro_calendar": ["official_macro_context", "public_macro_feeds", CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "macro_event_window": ["official_macro_context", "public_macro_feeds", "ticker_news_context", CENTRAL_BANK_CONTEXT_SOURCE_ID],
    ...
    "credit_stress": ["extended_quant_context", "public_policy_context", CENTRAL_BANK_CONTEXT_SOURCE_ID],
    ...
    "fed_speaker_calendar_surprise": ["official_macro_context", "public_macro_feeds", CENTRAL_BANK_CONTEXT_SOURCE_ID],
    ...
    "rate_volatility_context": ["official_macro_context", "extended_quant_context", CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "treasury_auction_context": ["official_macro_context", "public_macro_feeds", CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "central_bank_activity": ["official_macro_context", "public_macro_feeds", CENTRAL_BANK_CONTEXT_SOURCE_ID, GLOBAL_CENTRAL_BANK_SOURCE_ID, CENTRAL_BANK_SYNC_SOURCE_ID],
    "central_bank_calendar": ["official_macro_context", "public_macro_feeds", CENTRAL_BANK_CONTEXT_SOURCE_ID, GLOBAL_CENTRAL_BANK_SOURCE_ID, CENTRAL_BANK_SYNC_SOURCE_ID],
    "central_bank_policy": ["official_macro_context", "public_macro_feeds", CENTRAL_BANK_CONTEXT_SOURCE_ID, GLOBAL_CENTRAL_BANK_SOURCE_ID, CENTRAL_BANK_SYNC_SOURCE_ID],
    "central_bank_policy_divergence": ["official_macro_context", "fx_market_context", CENTRAL_BANK_CONTEXT_SOURCE_ID, GLOBAL_CENTRAL_BANK_SOURCE_ID, CENTRAL_BANK_SYNC_SOURCE_ID],
    "global_rate_differential_context": [GLOBAL_CENTRAL_BANK_SOURCE_ID, CENTRAL_BANK_SYNC_SOURCE_ID, "fx_market_context"],
    "central_bank_calendar_context": ["official_macro_context", GLOBAL_CENTRAL_BANK_SOURCE_ID, CENTRAL_BANK_SYNC_SOURCE_ID],
    "policy_divergence_surface": [GLOBAL_CENTRAL_BANK_SOURCE_ID, CENTRAL_BANK_SYNC_SOURCE_ID, "fx_market_context"],
    "central_bank_fx_transmission": [CENTRAL_BANK_SYNC_SOURCE_ID, "fx_market_context"],
    "central_bank_source_lineage": [CENTRAL_BANK_SYNC_SOURCE_ID, "source_verification"],
    "central_bank_swap_lines": [CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "fed_balance_sheet": [CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "fed_liquidity": [CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "fed_reserve_balances": [CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "financial_conditions": ["official_macro_context", CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "funding_liquidity_context": ["extended_quant_context", CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "funding_stress": ["extended_quant_context", CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "interest_on_reserve_balances": [CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "monetary_base": [CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "money_stock": [CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "net_liquidity": [CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "policy_corridor": [CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "repo_funding_curve_proxy": ["extended_quant_context", CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "repo_sofr_funding_pressure": ["extended_quant_context", CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "reverse_repo": [CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "sofr": ["extended_quant_context", CENTRAL_BANK_CONTEXT_SOURCE_ID],
    "treasury_general_account": [CENTRAL_BANK_CONTEXT_SOURCE_ID],
}
