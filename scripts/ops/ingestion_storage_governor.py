    ...
    *,
    ...
    return {
        ...
        "throttle_controls": {
            ...
            "decision_log_feature_mode": env_overrides.get("DECISION_LOG_FEATURE_MODE"),
            "decision_explanation_feature_mode": env_overrides.get("DECISION_EXPLANATION_FEATURE_MODE"),
            "signal_generation_sub_bot_window_seconds": _safe_int(
                env_overrides.get("SIGNAL_GENERATION_SUB_BOT_WINDOW_SECONDS"),
                0,
            ),
