...
def main() -> int:
    ...
    parser.add_argument('--hot-retention-hot-days', type=int, default=int(os.getenv('SQL_LINK_SERVICE_HOT_DAYS', '14')))
    parser.add_argument('--hot-retention-batch-size', type=int, default=int(os.getenv('SQL_LINK_SERVICE_HOT_BATCH_SIZE', '80000')))
    parser.add_argument('--hot-retention-min-interval-seconds', type=int, default=int(os.getenv('SQL_LINK_SERVICE_HOT_MIN_INTERVAL_SECONDS', '900')))
