...
SLEEVE_DEFAULTS = {
    ...
    "collateral_margin_liquidity": {
        "symbols": "BIL,SGOV,SHY,IEF,TLT,AGG,BND,USFR,TFLO,FLOT,LQD,HYG,JNK,KRE,XLF,JPM,BAC,GS,MS,SCHW,SPY,QQQ,VIXY",
        "context_symbols": "BIL,SGOV,SHY,IEF,TLT,LQD,HYG,JNK,KRE,XLF,SPY,QQQ,VIXY,UUP,/ZT,/ZF,/ZN,/ZB",
        "interval": "900",
        "min_interval": "600",
        "threshold_shift": "+0.22",
        "domain": "quant_models",
        "family": "collateral_margin_liquidity",
        "correlation_peers": "repo_securities_lending,xva_counterparty_margin,rates_credit_macro,runtime_capacity_governance,data_plane_backpressure_resilience",
        "source_gated": "0",
        "source_profile": "collateral_quality,margin_call,risk_haircut,forced_liquidation",
    },
    "dealer_positioning_gamma_inventory": {
        "symbols": "SPY,QQQ,IWM,DIA,VIXY,UVXY,SVXY,TLT,GLD,UUP,XLK,XLF,XLE,SMH,AAPL,MSFT,NVDA,AMD,TSLA,META,AMZN,JPM,XOM",
        "context_symbols": "SPY,QQQ,IWM,DIA,VIXY,UVXY,SVXY,TLT,GLD,UUP,XLK,XLF,SMH,/ES,/NQ,/RTY",
        "interval": "420",
        "min_interval": "300",
        "threshold_shift": "+0.20",
        "domain": "quant_models",
        "family": "dealer_positioning_gamma_inventory",
        "correlation_peers": "second_third_order_greeks,gamma_scalping,volatility_arbitrage,options_on_futures,signal_governance_integrity",
        "source_gated": "0",
    ...
    "etf_flow_creation_redemption": {
        ...
        "threshold_shift": "+0.20",
        "domain": "quant_models",
        "family": "etf_flow_creation_redemption",
        "correlation_peers": "portfolio_construction,liquidity_regime,market_data_tape_normalization,transaction_cost_slippage_intelligence,signal_governance_integrity",
        "source_gated": "0",
        "source_profile": "etf_flow_proxy,creation_redemption,authorized_participant,nav_premium_discount",
    },
    "signal_governance_integrity": {
        "symbols": "SPY,QQQ,IWM,DIA,TLT,GLD,UUP,VIXY,XLK,XLF,XLE,XLV,SMH,AAPL,MSFT,NVDA,JPM,XOM",
        "context_symbols": "SPY,QQQ,IWM,TLT,GLD,UUP,VIXY,XLK,XLF,XLE,XLV,SMH,AAPL,MSFT,NVDA,JPM,XOM,/ES,/NQ,/ZN",
        "interval": "900",
        "min_interval": "600",
        "threshold_shift": "+0.24",
        "domain": "quant_models",
        "family": "signal_governance_integrity",
        "correlation_peers": "model_risk_validation,feature_quality_data_confidence,alpha_research_os,expansion_quality_governance,portfolio_construction",
        "source_gated": "0",
        "source_profile": "ensemble_disagreement,signal_half_life,alpha_crowding,experiment_kill_criteria",
    },
    "runtime_capacity_governance": {
        "symbols": "SPY,QQQ,IWM,DIA,TLT,IEF,LQD,HYG,JNK,GLD,UUP,VIXY,XLK,XLF,XLE,SMH,AAPL,MSFT,NVDA,JPM,XOM",
        "context_symbols": "SPY,QQQ,IWM,TLT,IEF,LQD,HYG,JNK,GLD,UUP,VIXY,XLK,XLF,XLE,SMH,/ES,/NQ,/ZN,/CL",
        "interval": "900",
        "min_interval": "600",
        "threshold_shift": "+0.25",
        "domain": "quant_models",
        "family": "runtime_capacity_governance",
        "correlation_peers": "system_governor_expansion,low_latency_orchestration,data_plane_backpressure_resilience,liquidity_regime,alpha_research_os",
        "source_gated": "0",
        "source_profile": "runtime_lane_load,collector_fanout_budget,mlx_batch_governor,cotenant_guard",
    },
    "data_plane_backpressure_resilience": {
        "symbols": "SPY,QQQ,IWM,DIA,TLT,IEF,LQD,HYG,JNK,GLD,UUP,VIXY,XLK,XLF,XLE,SMH,AAPL,MSFT,NVDA,JPM,XOM,BTC-USD,ETH-USD",
        "context_symbols": "SPY,QQQ,IWM,TLT,IEF,LQD,HYG,JNK,GLD,UUP,VIXY,XLK,XLF,XLE,SMH,BTC-USD,ETH-USD,/ES,/NQ,/ZN",
        "interval": "900",
        "min_interval": "600",
        "threshold_shift": "+0.25",
        "domain": "quant_models",
        "family": "data_plane_backpressure_resilience",
        "correlation_peers": "institutional_data_plumbing,market_data_tape_normalization,runtime_capacity_governance,feature_quality_data_confidence,system_governor_expansion",
        "source_gated": "0",
        "source_profile": "sql_writer_queue,explanation_backlog,wal_checkpoint,storage_backpressure",
    },
    "halt_recovery_stability": {
        "symbols": "SPY,QQQ,IWM,DIA,TLT,IEF,LQD,HYG,JNK,GLD,UUP,VIXY,XLK,XLF,XLE,SMH,AAPL,MSFT,NVDA,JPM,XOM",
        "context_symbols": "SPY,QQQ,IWM,TLT,IEF,LQD,HYG,JNK,GLD,UUP,VIXY,XLK,XLF,XLE,SMH,/ES,/NQ,/ZN",
        "interval": "900",
        "min_interval": "600",
        "threshold_shift": "+0.25",
        "domain": "quant_models",
        "family": "halt_recovery_stability",
        "correlation_peers": "system_governor_expansion,global_halt_refresh,paper_trade_lock,expansion_quality_governance,runtime_capacity_governance",
        "source_gated": "0",
        "source_profile": "global_halt_clearance,sleeve_thaw_sequence,tripwire_root_cause,paper_lock_recovery",
    },
    "expansion_quality_governance": {
        ...
        "threshold_shift": "+0.25",
        "domain": "quant_models",
        "family": "expansion_quality_governance",
        "correlation_peers": "bot_admission,feature_quality_data_confidence,model_risk_validation,signal_governance_integrity,alpha_research_os",
        "source_gated": "0",
        "source_profile": "admission_capacity,label_taxonomy,training_readiness,report_freshness",
    },
    "neural_operator_surrogates": {
        ...
        "threshold_shift": "+0.18",
        "domain": "quant_models",
        "family": "neural_operator_surrogates",
        "correlation_peers": "gpu_quant_acceleration,qemc_path_volatility,state_space_models,quant_pricing_models,martingale_flow_pricing",
        "source_gated": "0",
        "source_profile": "fourier_neural_operator,deeponet,neural_cde,koopman_operator",
    },
    "uncertainty_robust_control": {
        "symbols": "SPY,QQQ,IWM,DIA,TLT,IEF,LQD,HYG,JNK,GLD,UUP,VIXY,UVXY,XLK,XLF,XLE,XLV,AAPL,MSFT,NVDA,JPM,XOM",
        "context_symbols": "SPY,QQQ,IWM,TLT,IEF,LQD,HYG,JNK,GLD,UUP,VIXY,UVXY,XLK,XLF,XLE,XLV,/ES,/NQ,/ZN,/CL,/GC",
        "interval": "600",
        "min_interval": "420",
        "threshold_shift": "+0.18",
        "domain": "quant_models",
        "family": "uncertainty_robust_control",
        "correlation_peers": "tail_dependency_risk,portfolio_construction,model_risk_validation,alpha_research_os,causal_regime_discovery",
        "source_gated": "0",
        "source_profile": "bayesian_uncertainty,conformal_interval,dro_optimizer,online_convex_control",
    },
    "causal_regime_discovery": {
        "symbols": "SPY,QQQ,IWM,DIA,TLT,IEF,LQD,HYG,JNK,GLD,UUP,VIXY,XLK,XLF,XLE,XLV,SMH,AAPL,MSFT,NVDA,JPM,XOM",
        "context_symbols": "SPY,QQQ,IWM,TLT,IEF,LQD,HYG,JNK,GLD,UUP,VIXY,XLK,XLF,XLE,XLV,SMH,/ES,/NQ,/ZN,/CL",
        "interval": "600",
        "min_interval": "420",
        "threshold_shift": "+0.18",
        "domain": "quant_models",
        "family": "causal_regime_discovery",
        "correlation_peers": "causal_omni_symbolic,event_intelligence,state_space_models,model_risk_validation,research_meta_governance",
        "source_gated": "0",
        "source_profile": "causal_dag,invariant_risk,bayesian_changepoint,hidden_semi_markov",
    },
    "martingale_flow_pricing": {
        ...
        "threshold_shift": "+0.18",
        "domain": "quant_models",
        "family": "martingale_flow_pricing",
        "correlation_peers": "quant_pricing_models,neural_operator_surrogates,qemc_path_volatility,volatility_arbitrage,uncertainty_robust_control",
        "source_gated": "0",
        "source_profile": "martingale_transport,normalizing_flow,least_squares_mc,rough_bergomi",
    },
    "alpha_research_os": {
        "symbols": "SPY,QQQ,IWM,DIA,TLT,IEF,LQD,HYG,JNK,GLD,UUP,VIXY,XLK,XLF,XLE,SMH,AAPL,MSFT,NVDA,JPM,XOM,BTC-USD,ETH-USD",
        "context_symbols": "SPY,QQQ,IWM,TLT,IEF,LQD,HYG,JNK,GLD,UUP,VIXY,XLK,XLF,XLE,SMH,BTC-USD,ETH-USD,/ES,/NQ,/ZN",
        ...
        "domain": "quant_models",
        "family": "alpha_research_os",
        "correlation_peers": "research_meta_governance,signal_governance_integrity,model_risk_validation,expansion_quality_governance,portfolio_construction",
        "source_gated": "0",
        "source_profile": "hypothesis_graph,bayesian_evidence,duplicate_alpha,compute_capital,research_committee",
    },
    "research_meta_governance": {
        ...
        "threshold_shift": "+0.26",
        "domain": "quant_models",
        "family": "research_meta_governance",
