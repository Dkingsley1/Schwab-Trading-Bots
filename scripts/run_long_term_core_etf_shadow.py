...
DEFAULT_CORE_ETF_SYMBOLS = "SPY,VOO,VTI,IVV,QQQ,SCHX,IWB,RSP,SPYM,VUG,VTV"
DEFAULT_CORE_CONTEXT_SYMBOLS = "SPY,QQQ,DIA,IWM,TLT,GLD"
DEFAULT_CORE_QUALITY_SYMBOLS = "SPY,VOO,VTI,IVV,QQQ,SCHX,IWB,RSP,SPYM,VUG,VTV"


def main() -> int:
    parser = argparse.ArgumentParser(description="Run long-term core ETF accumulation shadow profile.")
    ...
    parser.add_argument("--symbols", default=os.getenv("LONG_TERM_CORE_ETF_SYMBOLS", DEFAULT_CORE_ETF_SYMBOLS))
    parser.add_argument("--context-symbols", default=os.getenv("LONG_TERM_CORE_ETF_CONTEXT_SYMBOLS", DEFAULT_CORE_CONTEXT_SYMBOLS))
    parser.add_argument("--quality-symbols", default=os.getenv("LONG_TERM_CORE_QUALITY_SYMBOLS", DEFAULT_CORE_QUALITY_SYMBOLS))
    parser.add_argument("--interval-seconds", type=int, default=int(os.getenv("LONG_TERM_CORE_ETF_INTERVAL", "180")))
    parser.add_argument("--max-iterations", type=int, default=int(os.getenv("LONG_TERM_CORE_ETF_MAX_ITERS", "0")))
    ...
    env["SHADOW_PROFILE"] = "long_term_core_etf"
    ...
    print("Starting long-term core ETF profile...")
