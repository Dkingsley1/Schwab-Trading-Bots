...
RUNNER_SCRIPT="$PROJECT_ROOT/scripts/ops/run_soak_self_healing_launchd.sh"
PLIST_PATH="$HOME/Library/LaunchAgents/com.dankingsley.ops.soak_self_healing.plist"
LABEL="com.dankingsley.ops.soak_self_healing"
UID_NUM="$(id -u)"
...
<dict>
  ...
  <string>$LOG_DIR/ops_soak_self_healing.err.log</string>
</dict>
</plist>
PLIST
...
echo "Logs: $LOG_DIR/ops_soak_self_healing.out.log and $LOG_DIR/ops_soak_self_healing.err.log"
