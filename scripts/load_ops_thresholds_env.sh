...
pairs = {
  ...
  'PROMOTION_GATE_MIN_FORWARD_MEAN': pgp.get('min_forward_mean', 0.58),
  'PROMOTION_GATE_MIN_DELTA': pgp.get('min_delta', 0.00),
  'PROMOTION_GATE_MIN_TRADING_QUALITY_SCORE': pgp.get('min_trading_quality_score', 0.60),
  ...
  'GRADUATION_MIN_FORWARD_MEAN': gg.get('min_forward_mean', 0.58),
  'GRADUATION_MIN_DELTA': gg.get('min_delta', 0.00),
