...
def main() -> int:
    ...
    parser.add_argument("--min-runs", type=int, default=int(__import__("os").getenv("GRADUATION_MIN_RUNS", "24")))
    ...
    parser.add_argument("--min-mature-bots", type=int, default=int(__import__("os").getenv("GRADUATION_MIN_MATURE_BOTS", "12")))
    parser.add_argument("--min-mature-pass-rate", type=float, default=float(__import__("os").getenv("GRADUATION_MIN_MATURE_PASS_RATE", "0.25")))
