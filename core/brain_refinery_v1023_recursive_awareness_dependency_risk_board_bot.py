"""Registry-backed collection module for Dependency Risk Board.
...
BOT_ID = 'brain_refinery_v1023_recursive_awareness_dependency_risk_board_bot'
GENERATED_AT_UTC = '2026-05-04T00:44:26.741700+00:00'
BOT_SPEC = {'active': True,
 ...
 'sleeve_family': 'recursive_meta_awareness_control_plane',
 'sleeve_profile': 'deep_recursive_awareness',
 'slot_kind': 'deep_recursive_awareness_dependency_risk_board',
 'slot_label': 'Dependency Risk Board',
 'slot_objective': 'Map dependency, data, command, and library risk before upgrades are applied.',
 ...
 'storage_targets': ['governance/deep_recursive_awareness',
                     ...
                     'governance/deep_recursive_awareness/recursive_platform_map',
                     'governance/health/deep_recursive_awareness_latest.json'],
 'target_functions': ['dependency_utilization', 'library_utilization_router', 'commands_hygiene'],
...
BRAIN_REFINERY_V1023_RECURSIVE_AWARENESS_DEPENDENCY_RISK_BOARD_BOT_SPEC = BOT_SPEC
