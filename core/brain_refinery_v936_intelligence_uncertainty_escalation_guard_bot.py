"""Registry-backed collection module for Uncertainty Escalation Guard.
...
BOT_ID = 'brain_refinery_v936_intelligence_uncertainty_escalation_guard_bot'
GENERATED_AT_UTC = '2026-05-04T00:12:18.890462+00:00'
BOT_SPEC = {'active': True,
 ...
 'sleeve_family': 'meta_intelligence_control_plane',
 'sleeve_profile': 'intelligence_layer_advancement',
 'slot_kind': 'intelligence_layer_advancement_uncertainty_escalation_guard',
 'slot_label': 'Uncertainty Escalation Guard',
 'slot_objective': 'Escalate or downshift decisions when uncertainty, disagreement, or resource '
 ...
 'storage_targets': ['governance/intelligence_layer',
                     ...
                     'governance/intelligence_layer/backlog',
                     'governance/health/intelligence_layer_advancement_latest.json'],
 'target_functions': ['global_halt_status', 'operator_cockpit', 'ensemble_uncertainty'],
...
BRAIN_REFINERY_V936_INTELLIGENCE_UNCERTAINTY_ESCALATION_GUARD_BOT_SPEC = BOT_SPEC
