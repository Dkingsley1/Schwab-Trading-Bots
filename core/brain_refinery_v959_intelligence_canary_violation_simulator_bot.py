"""Registry-backed collection module for Canary Violation Simulator.
...
BOT_ID = 'brain_refinery_v959_intelligence_canary_violation_simulator_bot'
GENERATED_AT_UTC = '2026-05-04T00:12:18.913279+00:00'
BOT_SPEC = {'active': True,
 ...
 'sleeve_family': 'meta_intelligence_control_plane',
 'sleeve_profile': 'intelligence_layer_advancement',
 'slot_kind': 'intelligence_layer_advancement_canary_violation_simulator',
 'slot_label': 'Canary Violation Simulator',
 'slot_objective': 'Run dry canary violations to ensure guards catch unsafe promotions or '
                   'execution paths.',
 ...
 'storage_targets': ['governance/intelligence_layer',
                     ...
                     'governance/intelligence_layer/backlog',
                     'governance/health/intelligence_layer_advancement_latest.json'],
 'target_functions': ['golden_replay_guard', 'release_freeze', 'regression_guard'],
...
BRAIN_REFINERY_V959_INTELLIGENCE_CANARY_VIOLATION_SIMULATOR_BOT_SPEC = BOT_SPEC
