"""Registry-backed collection module for Decision Alternative Critic.
...
BOT_ID = 'brain_refinery_v939_intelligence_decision_alternative_critic_bot'
GENERATED_AT_UTC = '2026-05-04T00:12:18.893667+00:00'
BOT_SPEC = {'active': True,
 ...
 'sleeve_family': 'meta_intelligence_control_plane',
 'sleeve_profile': 'intelligence_layer_advancement',
 'slot_kind': 'intelligence_layer_advancement_decision_alternative_critic',
 'slot_label': 'Decision Alternative Critic',
 'slot_objective': 'Compare candidate actions against counterfactual paths before trust is lifted.',
 ...
 'storage_targets': ['governance/intelligence_layer',
                     ...
                     'governance/intelligence_layer/backlog',
                     'governance/health/intelligence_layer_advancement_latest.json'],
 'target_functions': ['decision_provenance',
...
BRAIN_REFINERY_V939_INTELLIGENCE_DECISION_ALTERNATIVE_CRITIC_BOT_SPEC = BOT_SPEC
