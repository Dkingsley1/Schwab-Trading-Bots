"""Registry-backed collection module for Causal Lesson Retrieval Scorer.
...
BOT_ID = 'brain_refinery_v975_apex_causal_lesson_retrieval_scorer_bot'
GENERATED_AT_UTC = '2026-05-04T00:23:05.549161+00:00'
BOT_SPEC = {'active': True,
 ...
 'sleeve_family': 'apex_meta_intelligence_control_plane',
 'sleeve_profile': 'apex_self_awareness_intelligence',
 'slot_kind': 'apex_self_awareness_intelligence_causal_lesson_retrieval_scorer',
 'slot_label': 'Causal Lesson Retrieval Scorer',
 'slot_objective': 'Score retrieved lessons by causal relevance to the current state instead of '
                   'keyword similarity.',
 'slot_priority': 'high',
 'storage_targets': ['governance/apex_intelligence',
                     'governance/apex_intelligence/self_model',
                     ...
                     'governance/apex_intelligence/research_frontier',
                     'governance/health/apex_self_awareness_intelligence_latest.json'],
 'target_functions': ['memory_retrieval', 'causal_discovery', 'operator_cockpit'],
...
BRAIN_REFINERY_V975_APEX_CAUSAL_LESSON_RETRIEVAL_SCORER_BOT_SPEC = BOT_SPEC
