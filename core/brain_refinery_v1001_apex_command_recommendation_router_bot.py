"""Registry-backed collection module for Command Recommendation Router.
...
BOT_ID = 'brain_refinery_v1001_apex_command_recommendation_router_bot'
GENERATED_AT_UTC = '2026-05-04T00:23:05.572026+00:00'
BOT_SPEC = {'active': True,
 ...
 'sleeve_family': 'apex_meta_intelligence_control_plane',
 'sleeve_profile': 'apex_self_awareness_intelligence',
 'slot_kind': 'apex_self_awareness_intelligence_command_recommendation_router',
 'slot_label': 'Command Recommendation Router',
 'slot_objective': 'Recommend the safest next command from current health, intent, and operating '
                   'mode.',
 'slot_priority': 'high',
 'storage_targets': ['governance/apex_intelligence',
                     'governance/apex_intelligence/self_model',
                     ...
                     'governance/apex_intelligence/research_frontier',
                     'governance/health/apex_self_awareness_intelligence_latest.json'],
 'target_functions': ['commands_hygiene', 'operator_cockpit', 'global_halt_status'],
...
BRAIN_REFINERY_V1001_APEX_COMMAND_RECOMMENDATION_ROUTER_BOT_SPEC = BOT_SPEC
