"""Registry-backed collection module for Circular Reasoning Detector.
...
BOT_ID = 'brain_refinery_v1031_recursive_awareness_circular_reasoning_detector_bot'
GENERATED_AT_UTC = '2026-05-04T00:44:26.748963+00:00'
BOT_SPEC = {'active': True,
 ...
 'sleeve_family': 'recursive_meta_awareness_control_plane',
 'sleeve_profile': 'deep_recursive_awareness',
 'slot_kind': 'deep_recursive_awareness_circular_reasoning_detector',
 'slot_label': 'Circular Reasoning Detector',
 'slot_objective': 'Detect when self-model outputs are being reused as evidence for themselves.',
 ...
 'storage_targets': ['governance/deep_recursive_awareness',
                     ...
                     'governance/deep_recursive_awareness/recursive_platform_map',
                     'governance/health/deep_recursive_awareness_latest.json'],
 'target_functions': ['system_self_model', 'decision_provenance', 'causal_evidence_gatekeeper'],
...
BRAIN_REFINERY_V1031_RECURSIVE_AWARENESS_CIRCULAR_REASONING_DETECTOR_BOT_SPEC = BOT_SPEC
