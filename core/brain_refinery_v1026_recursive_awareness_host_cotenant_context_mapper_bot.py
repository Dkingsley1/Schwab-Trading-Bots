"""Registry-backed collection module for Host Co-Tenant Context Mapper.
...
BOT_ID = 'brain_refinery_v1026_recursive_awareness_host_cotenant_context_mapper_bot'
GENERATED_AT_UTC = '2026-05-04T00:44:26.744461+00:00'
BOT_SPEC = {'active': True,
 ...
 'sleeve_family': 'recursive_meta_awareness_control_plane',
 'sleeve_profile': 'deep_recursive_awareness',
 'slot_kind': 'deep_recursive_awareness_host_cotenant_context_mapper',
 'slot_label': 'Host Co-Tenant Context Mapper',
 'slot_objective': 'Map local app context and reserve headroom for PyCharm, browsers, Logic Pro, '
                   'and Final Cut.',
 ...
 'storage_targets': ['governance/deep_recursive_awareness',
                     ...
                     'governance/deep_recursive_awareness/recursive_platform_map',
                     'governance/health/deep_recursive_awareness_latest.json'],
 'target_functions': ['creative_cotenant_guard', 'memory_efficiency', 'operator_control'],
...
BRAIN_REFINERY_V1026_RECURSIVE_AWARENESS_HOST_COTENANT_CONTEXT_MAPPER_BOT_SPEC = BOT_SPEC
