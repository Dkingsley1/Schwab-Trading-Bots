"""Registry-backed collection module for Alpha Freshness SLA Master.
...
BOT_ID = 'brain_refinery_v915_alpha_freshness_sla_master_bot'
GENERATED_AT_UTC = '2026-05-03T23:44:27.105180+00:00'
BOT_SPEC = {'active': True,
 ...
 'sleeve_family': 'alpha_intelligence_control_plane',
 'sleeve_profile': 'alpha_intelligence_evolution',
 'slot_kind': 'alpha_intelligence_evolution_freshness_sla_master',
 'slot_label': 'Alpha Freshness SLA Master',
 'slot_objective': 'Route stale feeds to degraded collection or summary-only mode before global '
                   'halts need to fire.',
 'slot_priority': 'high',
 'storage_targets': ['governance/alpha_intelligence',
                     'governance/alpha_intelligence/training_readiness',
                     ...
                     'governance/alpha_intelligence/cleanup_governor',
                     'governance/health/alpha_intelligence_evolution_latest.json'],
 'target_functions': ['artifact_freshness_slo',
                      'data_plane_recovery_controller',
                      'global_halt_preemption'],
...
BRAIN_REFINERY_V915_ALPHA_FRESHNESS_SLA_MASTER_BOT_SPEC = BOT_SPEC
