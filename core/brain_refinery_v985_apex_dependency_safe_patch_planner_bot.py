"""Registry-backed collection module for Dependency-Safe Patch Planner.
...
BOT_ID = 'brain_refinery_v985_apex_dependency_safe_patch_planner_bot'
GENERATED_AT_UTC = '2026-05-04T00:23:05.558303+00:00'
BOT_SPEC = {'active': True,
 ...
 'sleeve_family': 'apex_meta_intelligence_control_plane',
 'sleeve_profile': 'apex_self_awareness_intelligence',
 'slot_kind': 'apex_self_awareness_intelligence_dependency_safe_patch_planner',
 'slot_label': 'Dependency-Safe Patch Planner',
 'slot_objective': 'Plan upgrades by dependency order, write scope, tests, and rollback evidence.',
 ...
 'storage_targets': ['governance/apex_intelligence',
                     ...
                     'governance/apex_intelligence/research_frontier',
                     'governance/health/apex_self_awareness_intelligence_latest.json'],
 'target_functions': ['dependency_graph', 'commands_hygiene', 'regression_guard'],
...
BRAIN_REFINERY_V985_APEX_DEPENDENCY_SAFE_PATCH_PLANNER_BOT_SPEC = BOT_SPEC
