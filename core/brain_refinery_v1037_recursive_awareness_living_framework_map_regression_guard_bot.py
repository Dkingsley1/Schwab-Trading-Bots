"""Registry-backed collection module for Living Framework Map Regression Guard.
...
GENERATED_AT_UTC = '2026-05-04T00:44:26.755109+00:00'
BOT_SPEC = {'active': True,
 ...
 'slot_label': 'Living Framework Map Regression Guard',
 'slot_objective': 'Keep framework-map and system-overview reports aligned with registry truth '
                   'after expansions.',
 ...
 'storage_targets': ['governance/deep_recursive_awareness',
                     ...
                     'governance/deep_recursive_awareness/recursive_platform_map',
                     'governance/health/deep_recursive_awareness_latest.json'],
 'target_functions': ['report_quality_guard', 'system_explainers', 'strategy_inventory'],
...
BRAIN_REFINERY_V1037_RECURSIVE_AWARENESS_LIVING_FRAMEWORK_MAP_REGRESSION_GUARD_BOT_SPEC = BOT_SPEC
