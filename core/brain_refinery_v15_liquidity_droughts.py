...
# -----------------------------
# Liquidity droughts: low-vol periods + sudden jumps
...
def train_brain():
    ...
    prices = simulate_liquidity_droughts(n=5000)
    ...
    save_artifacts(brain, config, metrics, run_tag="brain_refinery_v15_liquidity_droughts")
