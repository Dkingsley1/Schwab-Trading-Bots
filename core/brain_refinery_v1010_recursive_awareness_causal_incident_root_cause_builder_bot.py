"""Registry-backed collection module for Causal Incident Root Cause Builder.
...
GENERATED_AT_UTC = '2026-05-04T00:44:26.728383+00:00'
BOT_SPEC = {'active': True,
 ...
 'sleeve_family': 'recursive_meta_awareness_control_plane',
 'sleeve_profile': 'deep_recursive_awareness',
 'slot_kind': 'deep_recursive_awareness_causal_incident_root_cause_builder',
 'slot_label': 'Causal Incident Root Cause Builder',
 'slot_objective': 'Build causal incident graphs from halt, feed, auth, queue, storage, and '
                   'resource evidence.',
 ...
 'storage_targets': ['governance/deep_recursive_awareness',
                     ...
                     'governance/deep_recursive_awareness/recursive_platform_map',
                     'governance/health/deep_recursive_awareness_latest.json'],
 'target_functions': ['global_halt_status', 'incident_timeline', 'operator_cockpit'],
...
BRAIN_REFINERY_V1010_RECURSIVE_AWARENESS_CAUSAL_INCIDENT_ROOT_CAUSE_BUILDER_BOT_SPEC = BOT_SPEC
