"""Registry-backed collection module for Policy Invariant Verifier v2.
...
BOT_ID = 'brain_refinery_v958_intelligence_policy_invariant_verifier_v2_bot'
GENERATED_AT_UTC = '2026-05-04T00:12:18.912350+00:00'
BOT_SPEC = {'active': True,
 ...
 'sleeve_family': 'meta_intelligence_control_plane',
 'sleeve_profile': 'intelligence_layer_advancement',
 'slot_kind': 'intelligence_layer_advancement_policy_invariant_verifier_v2',
 'slot_label': 'Policy Invariant Verifier v2',
 'slot_objective': 'Verify paper lock, halt, storage, and training gates cannot be bypassed by '
                   'intelligence layers.',
 ...
 'storage_targets': ['governance/intelligence_layer',
                     ...
                     'governance/intelligence_layer/backlog',
                     'governance/health/intelligence_layer_advancement_latest.json'],
 'target_functions': ['paper_trade_lock_guard', 'global_halt', 'new_bot_admission_guard'],
...
BRAIN_REFINERY_V958_INTELLIGENCE_POLICY_INVARIANT_VERIFIER_V2_BOT_SPEC = BOT_SPEC
