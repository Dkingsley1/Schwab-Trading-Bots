"""Registry-backed collection module for World Model Residual Scorer.
...
BOT_ID = 'brain_refinery_v938_intelligence_world_model_residual_scorer_bot'
GENERATED_AT_UTC = '2026-05-04T00:12:18.892516+00:00'
BOT_SPEC = {'active': True,
 ...
 'sleeve_family': 'meta_intelligence_control_plane',
 'sleeve_profile': 'intelligence_layer_advancement',
 'slot_kind': 'intelligence_layer_advancement_world_model_residual_scorer',
 'slot_label': 'World Model Residual Scorer',
 'slot_objective': "Score when live behavior diverges from the platform's expected world model.",
 'slot_priority': 'high',
 'storage_targets': ['governance/intelligence_layer',
                     'governance/intelligence_layer/metacognition',
                     'governance/intelligence_layer/world_model',
                     ...
                     'governance/intelligence_layer/backlog',
                     'governance/health/intelligence_layer_advancement_latest.json'],
 'target_functions': ['regime_router', 'feature_quality', 'operator_cockpit'],
...
BRAIN_REFINERY_V938_INTELLIGENCE_WORLD_MODEL_RESIDUAL_SCORER_BOT_SPEC = BOT_SPEC
