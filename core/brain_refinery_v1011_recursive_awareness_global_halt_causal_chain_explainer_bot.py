"""Registry-backed collection module for Global Halt Causal Chain Explainer.
...
BOT_ID = 'brain_refinery_v1011_recursive_awareness_global_halt_causal_chain_explainer_bot'
GENERATED_AT_UTC = '2026-05-04T00:44:26.729750+00:00'
BOT_SPEC = {'active': True,
 ...
 'sleeve_family': 'recursive_meta_awareness_control_plane',
 'sleeve_profile': 'deep_recursive_awareness',
 'slot_kind': 'deep_recursive_awareness_global_halt_causal_chain_explainer',
 'slot_label': 'Global Halt Causal Chain Explainer',
 'slot_objective': 'Explain whether a halt came from real risk, stale health, backlog pressure, '
                   'auth, storage, or sleeve collapse.',
 ...
 'storage_targets': ['governance/deep_recursive_awareness',
                     ...
                     'governance/deep_recursive_awareness/recursive_platform_map',
                     'governance/health/deep_recursive_awareness_latest.json'],
 'target_functions': ['global_halt_clear_blockers',
                      'health_gates',
...
BRAIN_REFINERY_V1011_RECURSIVE_AWARENESS_GLOBAL_HALT_CAUSAL_CHAIN_EXPLAINER_BOT_SPEC = BOT_SPEC
