"""Registry-backed collection module for Regime State Space Mapper.
...
BOT_ID = 'brain_refinery_v979_apex_regime_state_space_mapper_bot'
GENERATED_AT_UTC = '2026-05-04T00:23:05.552663+00:00'
BOT_SPEC = {'active': True,
 ...
 'sleeve_family': 'apex_meta_intelligence_control_plane',
 'sleeve_profile': 'apex_self_awareness_intelligence',
 'slot_kind': 'apex_self_awareness_intelligence_regime_state_space_mapper',
 'slot_label': 'Regime State Space Mapper',
 'slot_objective': 'Map current macro, microstructure, volatility, liquidity, and cross-asset '
                   'regime state.',
 'slot_priority': 'high',
 'storage_targets': ['governance/apex_intelligence',
                     'governance/apex_intelligence/self_model',
                     ...
                     'governance/apex_intelligence/research_frontier',
                     'governance/health/apex_self_awareness_intelligence_latest.json'],
 'target_functions': ['market_regime_router', 'macro_context_sync', 'microstructure'],
...
BRAIN_REFINERY_V979_APEX_REGIME_STATE_SPACE_MAPPER_BOT_SPEC = BOT_SPEC
